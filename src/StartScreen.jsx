import { Icon, paidLabel } from './util.jsx'
...
export default function StartScreen({ tables, meName, onOpen, onNew }) {
  const { Button, Avatar, Badge } = window.WhoPaidDesignSystem_ce3383
  return (
